...
title = Enerflux_smart_App

# (str) Package name
package.name = enerfluxmobile
...
source.include_exts = py,png,jpg,kv,atlas,json,wav,mp3,xml
android.add_xml_resources = res/xml/device_filter.xml
...
requirements = python3, kivy, ffpyplayer,pyjnius,pyserial,usbserial4a
...
android.permissions = CAMERA, INTERNET, RECORD_AUDIO, MODIFY_AUDIO_SETTINGS, READ_EXTERNAL_STORAGE, WRITE_EXTERNAL_STORAGE
...
android.gradle_dependencies = 'com.github.mik3y:usb-serial-for-android:3.11.0'.
